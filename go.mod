module github.com/constant-null/tg-efs
...
require (
	...
	github.com/ydb-platform/ydb-go-yc v0.12.2
)
...
require (
	...
	github.com/yandex-cloud/go-genproto v0.0.0-20240812165244-9268830bb9c8 // indirect
